...
foreach inst $allInsts {
    ...
    if {[string match "sky130_sram_1rw1r*" $name]} {
        ...
        foreach iterm [$inst getITerms] {
            ...
            if {$net != "NULL"} {
                puts "set special on : [$net getName]\n"
                $net setSpecial
            }
        }
        incr cnt
...
set_global_routing_layer_adjustment 2 0.05
set_global_routing_layer_adjustment 3 0.05
set_global_routing_layer_adjustment 4 0.05
set_global_routing_layer_adjustment 5 0.05
set_global_routing_layer_adjustment $MAX_ROUTING_LAYER 0.3
